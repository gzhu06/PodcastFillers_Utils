...
parser.add_argument('-sed_eval_path', required=True, type=str, help='folder path contains episode prediction')
parser.add_argument('-table', required=True, type=int, help='table index to reproduce, 1 or 2')
...
if __name__ == '__main__':
	...
	gt_folder = os.path.join(args.sed_eval_path, 'ground_truth', 'Table' + str(args.table))
	est_folder = os.path.join(args.sed_eval_path, 'AVCFillerNet_predictions', 'Table' + str(args.table))
